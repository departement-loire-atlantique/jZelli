...
public class QuestionZelliAgeComparator extends BasicComparator<QuestionZelli>{
  ...
  public int compare(QuestionZelli questionZelli1, QuestionZelli questionZelli2) {
    ...
    // Retrieve age
    String dateNaissanceStr1 = questionZelli1.getAuthor().getExtraData("extra.Member.jcmsplugin.zelli.datenaissance");
    String dateNaissanceStr2 = questionZelli2.getAuthor().getExtraData("extra.Member.jcmsplugin.zelli.datenaissance");
